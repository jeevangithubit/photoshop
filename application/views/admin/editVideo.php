  ...
  <div class="container" style="background-color: #9de4f9;">
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <form method="post" action="<?php echo site_url('Admin/updateVideo'); ?>" enctype="multipart/form-data" style="margin-left: 220px;">
          <?php
            foreach ($data as $value) {
          ?>
            <input type="hidden" name="id" value="<?php echo $value['id'];?>">
          <div class="form-group">
            <label style="font-weight: 700;">Video</label>
            <input class="form-control" id="video" type="file" name="video" value="<?php echo $value['video'];?>">
          </div>
